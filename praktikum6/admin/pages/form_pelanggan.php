...
<div class="content-wrapper">
  <div class="card">
    <form method="POST" action="pages/proses_pelanggan.php" class="m-3">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <div class="input-group">
            ...
            <input id="jk" name="jk" value="P" type="radio" class="form-control" required>Perempuan
          </div>
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        <label for="tgl_lahir" class="col-4 col-form-label" required>Tanggal Lahir</label>
        <div class="col-8">
          <div class="input-group">
            <div class="input-group-prepend">
              <div class="input-group-text">
            ...
            <input id="tgl_lahir" name="tgl_lahir" value="" type="date" class="form-control" required>
          </div>
        </div>
      </div>
      <div class="form-group row">
